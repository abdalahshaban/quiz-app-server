(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [
                ...
                {
                    path: 'teacher',
                    loadChildren: function () { return Promise.resolve( /*! import() */).then(__webpack_require__.bind(null, /*! ./teacher/teacher.module */ "./src/app/teacher/teacher.module.ts")).then(function (m) { return m.TeacherModule; }); }
                }
            ];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TokenserviceService = /** @class */ (function () {
                ...
                TokenserviceService.prototype.DeleteToken = function () {
                    localStorage.removeItem('token');
                    this.router.navigate(['']);
                };
                TokenserviceService.prototype.GetPayload = function () {
            ...
            TokenserviceService.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserGuard = /** @class */ (function () {
                function UserGuard(tokenService, router) {
                    this.tokenService = tokenService;
                    this.router = router;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            MaterialModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
                    ...
                    ].concat(exportedMaterial),
                    exports: exportedMaterial.slice()
                })
            ], MaterialModule);
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AllQuizeComponent = /** @class */ (function () {
                ...
                AllQuizeComponent.prototype.getAllQuiz = function () {
                    var _this = this;
                    this.teacherSer.getQuiz().subscribe(function (data) {
                        if (data.length > 0) {
                        ...
                        _this.teacherSer.errorHandler('can not get quizs');
                        if (err.error.token === null) {
                            _this.tokenServ.DeleteToken();
                        }
                    });
                };
                ...
                AllQuizeComponent.prototype.deleteBtn = function (id) {
                    var _this = this;
                    this.teacherSer.deleteQuiz(id).subscribe(function (data) {
                        _this.getAllQuiz();
                        _this.teacherSer.successHandle('Quiz Deleted');
                    }, function (err) {
                        _this.teacherSer.errorHandler('Failed TO Delete This Item');
                    });
                };
                ...
                return AllQuizeComponent;
            }());
            AllQuizeComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditFormComponent = /** @class */ (function () {
                function EditFormComponent(router, route, teacherServ, fb) {
                    this.router = router;
                    this.route = route;
                ...
                EditFormComponent.prototype.init = function () {
                ...
                EditFormComponent.prototype.pagination = function () {
                    var _this = this;
                    this.paginator.page.subscribe(function (data) {
                        _this.teacherServ.getQuizById({ page: ++data.pageIndex, perPage: data.pageSize }, _this.id)
                            .subscribe(function (data) {
                            _this.quizData = data['docs'];
                            _this.resultLength = data['total'];
                        });
                    }, function (err) {
                        _this.teacherServ.errorHandler(err);
                    });
                };
                EditFormComponent.prototype.setQuizToForm = function () {
                    var _this = this;
                    this.route.params.subscribe(function (params) {
                        ...
                        _this.teacherServ.getQuizById({ page: 1, perPage: 1 }, _this.id).subscribe(function (data) {
                            ...
                            _this.teacherServ.errorHandler('Failed To Get Quiz');
                        });
                    });
                };
                EditFormComponent.prototype.editQuestion = function (questionData) {
                    var _this = this;
                    //check possibleAnswer
                    var check = this.teacherServ.checkIfCorrectAnswerInPossible(questionData);
                    if (check) {
                        this.teacherServ.updateQuestionById(questionData).subscribe(function (data) {
                            _this.teacherServ.successHandle(data['message']);
                        }, function (err) {
                            _this.teacherServ.errorHandler('can not update item');
                        });
                    }
                    else {
                ...
                EditFormComponent.prototype.deleteQuestion = function (id) {
                    var _this = this;
                    this.teacherServ.deleteQuestion(id).subscribe(function (data) {
                        _this.teacherServ.successHandle('Question Deleted');
                    }, function (err) {
                        _this.teacherServ.errorHandler('can not delete this question');
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HometeacherComponent = /** @class */ (function () {
                function HometeacherComponent(router, route) {
                    this.router = router;
                    this.route = route;
                    this.allQuiz = false;
                ...
                HometeacherComponent.prototype.changeTabs = function (value) {
                    if (value === 'all-quiz') {
                        this.allQuiz = true;
                        this.publishedQuize = false;
                    }
            ...
            HometeacherComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var PublishedQuizeComponent = /** @class */ (function () {
                function PublishedQuizeComponent(teacherServ) {
                    this.teacherServ = teacherServ;
                    this.displayedColumns = ['id', 'action'];
                    this.dataSource = [];
                }
                PublishedQuizeComponent.prototype.ngOnInit = function () {
                    this.getAllPublishedQuiz();
                };
                PublishedQuizeComponent.prototype.getAllPublishedQuiz = function () {
                    var _this = this;
                    this.teacherServ.getPublishQuiz().subscribe(function (data) {
                        if (data.length > 0) {
                            _this.dataSource = data;
                        }
                        else {
                        ...
                        _this.teacherServ.errorHandler('can not get publish quizs');
                    });
                };
                PublishedQuizeComponent.prototype.deleteBtn = function (id) {
                    var _this = this;
                    this.teacherServ.deleteQuiz(id).subscribe(function (data) {
                        _this.getAllPublishedQuiz();
                        _this.teacherServ.successHandle('Quiz Deleted');
                    }, function (err) {
                        _this.teacherServ.errorHandler('Failed TO Delete This Item');
                    });
                };
                return PublishedQuizeComponent;
            }());
            PublishedQuizeComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuizFormComponent = /** @class */ (function () {
                function QuizFormComponent(fb, router, route, snackBar, teacherServ) {
                    this.fb = fb;
                    this.router = router;
                    this.route = route;
            ...
            QuizFormComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToolbarComponent = /** @class */ (function () {
                function ToolbarComponent(tokenService, router, route) {
                    this.tokenService = tokenService;
                    this.router = router;
                    this.route = route;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BASE_URL = "quiz-app";
            var TeacherService = /** @class */ (function () {
                function TeacherService(http, router, route, snackBar) {
                    this.http = http;
                    this.router = router;
                    this.route = route;
                    this.snackBar = snackBar;
                }
                TeacherService.prototype.successHandle = function (message) {
                    this.snackBar.open(message, 'Success', {
                        duration: 2000
                    });
                };
                TeacherService.prototype.errorHandler = function (message) {
                    this.snackBar.open(message, 'Error', {
                        duration: 2000
                    });
                };
                TeacherService.prototype.checkIfCorrectAnswerInPossible = function (value) {
                    //if create Quiz
                    var arr = [value];
                ...
                TeacherService.prototype.createQuiz = function (body) {
                    return this.http.post(BASE_URL + "/add-quiz", body);
                };
                TeacherService.prototype.getQuiz = function () {
                    return this.http.get(BASE_URL + "/all-quiz");
                };
                TeacherService.prototype.deleteQuiz = function (id) {
                    return this.http.post(BASE_URL + "/delete-quiz", { id: id });
                };
                TeacherService.prototype.getQuizById = function (_a, id) {
                    var _b = _a.page, page = _b === void 0 ? 1 : _b, _c = _a.perPage, perPage = _c === void 0 ? 1 : _c;
                    return this.http.post(BASE_URL + "/get-quiz?page=" + page + "&perPage=" + perPage, { id: id });
                };
                // getQuizById(id: string): Observable<Quiz> {
                //   return this.http.post<Quiz>(`${BASE_URL}/get-quiz`, { id })
                // }
                TeacherService.prototype.updateQuestionById = function (body) {
                    return this.http.put(BASE_URL + "/update-question", body);
                };
                TeacherService.prototype.deleteQuestion = function (id) {
                    return this.http.delete(BASE_URL + "/delete-question/" + id);
                };
                TeacherService.prototype.publishQuiz = function (id) {
                    return this.http.put(BASE_URL + "/publish-quiz", { id: id });
                };
